        ...
        Column(
            ...
            Box(
                ...
                Column {
                    ...
                    AppRating(rating = rating, onRatingChanged = { newRating ->
                        rating = newRating
                    })
                    ...
                    Text(
                        text = "Apa yang harus dikembangkan?",
                        fontSize = 20.sp,
                        color = Color.Black,
                        fontWeight = Bold,
                    )
...
@Composable
fun AppRating(rating: Int, onRatingChanged: (Int) -> Unit) {
    Row {
        for (i in 1..5) {
            val imageRes = if (i <= rating) R.drawable.baseline_emoji_emotions_24 else R.drawable.baseline_insert_emoticon_24
            Image(
...
fun sendFeedbackEmail(context: Context, feedbackText: String, rating: Int) {
    ...
    val json = JSONObject().apply {
        ...
        put("from", JSONObject().apply {
            put("email", "alwaysmori16@gmail.com")
        })
